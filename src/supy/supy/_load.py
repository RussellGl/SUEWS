...
def resample_forcing_met(
    ...
    # if tstep of obs is larger than tstep of the model then interpolation
    # is needed
    ...
    # if tstep of model and tstep of obs are the same then no interpolation
    # is necessary
    elif tstep_in == tstep_mod:
        data_met_tstep = data_met_raw
